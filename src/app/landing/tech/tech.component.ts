...
export class TechComponent implements OnInit {
  ...
  constructor() { 
      this.items = [
        ...
        {
          name: 'Angular 4',
          description: "We used this platform to finalize our web application's front-end from the work we had done in Visual Studio. With this, we made our initially static website into a web app.",
