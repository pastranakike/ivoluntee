...
export class TechComponent implements OnInit {
  ...
  constructor() { 
      this.items = [
        {
          name: 'GitHub',
          description: "We used GitHub for version control and to efficiently work on the app from several devices at once without interrupting one another's work. Here is our repository: https://github.com/pastranakike/ivoluntee",
        ...
        },
        {
          ...
          description: "We used Visual Studio as our platform of choice for working on the website, since it neatly organizes everything in the screen.",
        ...
        {
          name: 'Angular 4',
          description: "We used this platform to finalize our web application's front-end from the work we had done in Visual Studio. With this, we made our initially static website into an app",
        ...
        {
          name: 'Python',
          description: "We used Python to link the MongoDB and Firebase databases with the front-end and to code the servers running the application's back-end with Flask.",
        ...
        {
          name: 'Flask',
          description: "We used the Flask RESTful API in order to create a server that would allow interaction between users and the web application.",
